    ...
    : QWidget(parent), deckStateManager(_deckStateManager), styleProxy(_styleProxy)
{
    ...
    aUndo->setIcon(loadColorAdjustedPixmap("theme:icons/arrow_undo"));
    ...
    aRedo->setIcon(loadColorAdjustedPixmap("theme:icons/arrow_redo"));
    ...
    historyButton->setButtonIcon(loadColorAdjustedPixmap("theme:icons/arrow_history"));
